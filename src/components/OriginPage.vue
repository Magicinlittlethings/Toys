<template>
  <div class="origin text-white  relative pb-40">
      <img class=" absolute w-screen h-full" src="Frame1000002745.png">
      <p class="font-main text-6xl  font-bold text-center mb-12 pt-12  ">
          Toy Face Origins
      </p>
      <p class="text-left text-base px-24">
        ...
        <p class="text-left text-base px-24 mt-4">
